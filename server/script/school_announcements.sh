#!/bin/bash
# Run from project root. This script is intended to be run from a cron job to play the school announcements.

set -Eeuo pipefail

echo "School announcements at $(date)"
