...
def _stub_playback(monkeypatch) -> StubMpdPlayer:
    ...
    monkeypatch.setattr("homeaudio.vcal.playback.mpd_connection", fake_mpd_connection)
...
def test_check_for_notifications_plays_due_snoozed_notification_with_nothing_else_due(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "homeaudio.vcal.event_notifications.snooze.due_snoozed_event_notifications",
