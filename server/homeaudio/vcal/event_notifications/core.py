...
def check_for_event_notifications(base_time, window, calendar_days: list[CalendarDay], event_notification_settings: EventNotificationSettings | None = None, departure_notification_settings: DepartureNotificationSettings | None = None) -> tuple[str | None, str | None]:
    event_notification_settings = event_notification_settings or EventNotificationSettings()
